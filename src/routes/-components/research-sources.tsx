...
const researchSources = [
  {
    ...
    description: "in a rigorous trial with 4,000+ developers. This isn't speculation—it's the new reality of coding with AI.",
  ...
  },
  {
    ...
    description: "while maintaining code quality. The consulting giant confirms: AI-powered coding is the competitive advantage.",
  ...
  },
  {
    ...
    description: "already use AI tools, with 81% reporting measurable productivity gains. The industry has spoken.",
  ...
  },
  {
    ...
    description: "in controlled studies. When Amazon validates AI coding tools, you know they're here to stay.",
  ...
  },
  {
    ...
    description: "at Palo Alto Networks with 2,000 developers. Real companies, real results, real competitive advantage.",
  ...
  },
  {
    ...
    description: "processing 195 million lines weekly. This is the largest AI coding experiment in history—and it's working.",
  ...
  return (
    <div className="group relative h-full bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 border-2 border-gray-300 dark:border-gray-600 hover:border-theme-400 dark:hover:border-theme-500 transition-all duration-500 hover:bg-white/60 dark:hover:bg-gray-900/60 hover:shadow-2xl hover:shadow-theme-500/20">
      ...
      <div className="absolute top-3 right-3 opacity-5 group-hover:opacity-15 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6">
        ...
        >
          {glyphPath.includes("M") ? (
            <path d={glyphPath} className="animate-pulse" stroke={glyphPath.includes("L") ? "currentColor" : undefined} strokeWidth={glyphPath.includes("L") ? "2" : undefined} fill={glyphPath.includes("L") ? "none" : "currentColor"} />
          ) : (
      ...
      <div className="relative z-10">
        <h3 className={`font-semibold mb-4 text-xl text-${color}-600 dark:text-${color}-400 group-hover:text-${color}-500 transition-colors duration-300`}>
          {title}
        </h3>
