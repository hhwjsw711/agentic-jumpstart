      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16 items-stretch">
          <ScrollScale delay={0.3}>
            <FeatureCard
              icon={<Zap className="w-8 h-8 text-theme-500 group-hover:text-theme-400 group-hover:scale-110 transition-all duration-300" />}
              title="10x Speed"
              ...
              glyphExtra={<circle cx="12" cy="12" r="3" className="animate-pulse" />}
            />
          </ScrollScale>

          <ScrollScale delay={0.4}>
            <FeatureCard
              icon={<Brain className="w-8 h-8 text-theme-500 group-hover:text-theme-400 group-hover:scale-110 transition-all duration-300" />}
              ...
              glyphExtra={<circle cx="12" cy="8" r="2" className="animate-bounce" />}
            />
          </ScrollScale>

          <ScrollScale delay={0.5}>
            <FeatureCard
              icon={<Rocket className="w-8 h-8 text-theme-500 group-hover:text-theme-400 group-hover:scale-110 transition-all duration-300" />}
              title="Ship Faster"
...
function FeatureCard({ icon, title, description, glyphPath, glyphExtra }: FeatureCardProps) {
  return (
