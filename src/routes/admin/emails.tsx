...
export const Route = createFileRoute("/admin/emails")({
  ...
  loader: ({ context }) => {
    return {
      emailBatches: context.queryClient.ensureQueryData(
        emailBatchesQueryOptions
      ),
      usersForEmailing: context.queryClient.ensureQueryData(
...
function AdminEmailsPage() {
  ...
  const { data: emailBatches } = useSuspenseQuery(emailBatchesQueryOptions);
  const { data: usersForEmailing } = useSuspenseQuery(
    usersForEmailingQueryOptions
  );
