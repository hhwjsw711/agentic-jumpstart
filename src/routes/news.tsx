    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4">
          AI <span className="text-theme-600 dark:text-theme-400">News</span>
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Stay up to date with the latest AI tools, YouTube videos, blog posts, and changelog updates. 
          Curated content about Claude, Cursor, Cline, LLMs, and more.
        </p>
      </div>
      ...
      <div className="grid gap-6">
        {filteredEntries.map((entry) => (
          <Card key={entry.id} className="group hover:shadow-lg transition-shadow duration-200">
        ...
        {filteredEntries.length === 0 && !isLoading && (
          <Card className="text-center py-12">
            <CardContent>
              ...
              <h3 className="text-xl font-semibold mb-2">No news entries found</h3>
