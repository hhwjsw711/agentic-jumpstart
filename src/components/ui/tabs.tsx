...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-md px-4 py-2 text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-theme-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:text-theme-700 dark:hover:text-theme-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-theme-500 data-[state=active]:to-theme-600 data-[state=active]:text-white data-[state=active]:shadow-elevation-2 hover:shadow-elevation-1 data-[state=active]:hover:from-theme-600 data-[state=active]:hover:to-theme-700",
      className
    )}
    {...props}
  />
