...
CREATE INDEX "news_tags_name_idx" ON "app_news_tag" USING btree ("name");--> statement-breakpoint
...
CREATE UNIQUE INDEX "news_entry_tags_unique" ON "app_news_entry_tag" USING btree ("news_entry_id","news_tag_id");